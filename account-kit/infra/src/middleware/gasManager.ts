...
import type { PermitMessage, PermitDomain } from "../gasManager.js";
...
import { AbstractSmartAccountClient } from "../clients/SmartAccountClient.js";
import { abstractFeeEstimator } from "./feeEstimator.js";
 ...
 * if you use `createAbstractSmartAccountClient`, this middleware is already
  ...
  return {
    ...
    feeEstimator: (uo, args) => {
      return feeEstimatorOverride
        ...
        : bypassPaymasterAndData(args.overrides)
          ? abstractFeeEstimator(transport)(uo, args)
    ...
    paymasterAndData: async (
      ...
      const result = await (client as AbstractSmartAccountClient).request({
